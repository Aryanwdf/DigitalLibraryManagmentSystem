	...
	public PersonMaintenance(LibraryMenu lm, StudentControllerInterface studentController,
		...
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent me) {
				PersonMaintenance.this.libraryMenu.setVisible(true);
				PersonMaintenance.this.libraryMenu.setParentActive();
				PersonMaintenance.this.dispose();
			}
		});
